...
// 찍으면 개발자 값이 사용자 화면에 샌다. "자사"는 공급자 쪽 말이라
// 처음 보는 사용자에게 안 와닿는다는 지적(fix round 1)을 받아 이 설계
// 문서 자신이 쓰는 말("브랜드 자체 앱이나 사이트의 행사")로 바꿨다.
// 개발자 확인 필요 - 다른 표현을 원하면 알려줄 것.
export const OWN_LABEL = '브랜드 자체'
